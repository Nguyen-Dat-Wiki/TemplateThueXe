...
<body>
    ...
    <div class="page-heading about-heading header-text"
        style="background-image: url(../assets/img/banner_detail.png);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="section mb-3 p-3">
                            <div class="model row">
                                <div class="col-12 col-sm-6 Product">
                                    <img class="imgDetail" alt="<?php echo $resu[0]['car_name'] ?>"
                                        src="<?php echo $resu[0]['car_img'] ?>" class="img-vehicle-detail">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div>
                                        ...
                                        <div class="infoDetail row">
                                            <div class="col-6">
                                                <div class="vehicle-spec mb-2"><i class="fa-solid fa-gas-pump"></i><span
                                                        class="ml-2"><?php echo $resu[0]['engine'] ?></span>
                                                </div>
                                                <div class="vehicle-spec mb-2"><i class="fa-solid fa-gas-pump"></i><span
                                                        class="ml-2"><?php echo $resu[0]['wattage'] ?></span>
                                                </div>
                                                <div class="vehicle-spec mb-2"><i
                                                        class="fa-solid fa-steering-wheel"></i><span
                                                        class="ml-2"><?php echo $resu[0]['gearbox'] ?></span>
                                                </div>
                                                <div class="vehicle-spec mb-2"><i class="fa-solid fa-wrench"></i><span
                                                        class="ml-2"><?php echo $resu[0]['vehical_size'] ?>mm</span>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="vehicle-spec mb-2"><i
                                                        class="fa-solid fa-seat-airline"></i><span
                                                        class="ml-2"><?php echo $resu[0]['seat'] ?> chỗ</span>
                                                </div>
                                                <div class="vehicle-spec mb-2"><i class="fa-solid fa-car"></i><span
                                                        class="ml-2"><?php echo $resu[0]['brand'] ?></span>
                                                </div>
                                                <div class="vehicle-spec mb-2"><i class="fa-solid fa-car-side"></i><span
                                                        class="ml-2">6.3L/100km</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="btn-clickover col-9">
                                        <?php 
                                            ...
                                            if (isset($_SESSION['account_id'])) {
                                                ...
                                                $sql = "SELECT status from car_like where customer_id=$account_id and car_id=$id";
                                                $arr = $mySQLCon->getAllData($sql);
                                                if (count($arr) ==1){
                                    ...
                                    <?php  include '../layouts/info.php'; ?>
                                        <div class="section p-3 mt-2">
                                            ...
                                            <form class="formGia" action="" method="POST">
                                                <div class="addon">
                                                    <div class="addon-row"><label><input type="checkbox" class="boxGia"
                                                                name="package1" value="insurance" checked="">&nbsp;Bảo hiểm
                                                            xe</label>
                                                        <i class="fa-solid fa-circle-question" data-toggle="modal"
                                                    ...
                                                    <div class="addon-row">
                                                        <label>
                                                            <input type="checkbox"
                                                                <?php echo isset($_POST["package2"])? 'checked': ''?>
                                                                class="boxGia" name="package2" value="facilitation">
                                                ...
                                                ?>
                                                        ...
                                                        <div class="addon-row">
                                                            <label>
                                                                <input type="checkbox"
                                                                    <?php echo isset($_POST["package3"])? 'checked' : '' ?>
                                                                    class="boxGia" name="package3" value="500">
                                        ...
                                        <div class="section mt-3 p-2">
                                            ...
                                            <div class="price-detail">
                                                <div class="price-row mt-1"><span class="price-label">Giá cơ bản</span><span
                                                        class="price-value"><?php echo $gia?>.000&nbsp;đ</span></div>
                                            </div>
                                            <div class="mt-4">
                                            ...
                                            <form action="../controller/usercontroller.php" method="POST">
                                                ...
                                                <div class="price-row mt-1">
                                                    ...
                                                    <span
                                                        class="price-value"><?php
                                                            $tong =  $gia + $gia2 + $gia3;
                                                            $format_number_1 = number_format($tong); echo ''.$format_number_1.'.000'; ?>&nbsp;đ</span>
                                                ...
                                                <div class="section p-3 mt-3">
                                                    <button type="submit"
                                                        id="<?php echo (isset($_SESSION['account_id'])? 'booked' : 'book_aleart') ?>"
                                                        name="useraction" class="mt-2 btn btn-primary btn-block"
                                                        value="book">Đặt xe</button>
